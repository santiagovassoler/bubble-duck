...
-(void) initImagesIntoArray 
{
 ...
 //       CCSprite *platformLeft = [CCSprite spriteWithFile:leftImageName];
		CCSprite *platformLeft = [CCSprite spriteWithSpriteFrameName:leftImageName];
 ...
 //       [spriteNode addChild:platformLeft z:0];
		[self addChild:platformLeft z:0];
		
		
//        CCSprite *platformRight = [CCSprite spriteWithFile:rightImageName];
       CCSprite *platformRight = [CCSprite spriteWithSpriteFrameName:rightImageName];
      ...
      //  [spriteNode addChild:platformRight z:0];
...
//        CCSprite *platformMid = [CCSprite spriteWithFile:middleImageName];
    	CCSprite *platformMid = [CCSprite spriteWithSpriteFrameName:middleImageName];
	...
	//	[spriteNode addChild:platformMid z:0];
...
-(void) initPlatformWithId:(int)Id andWithNum:(int)max andCoordinateY:(float)coorY
{
   ...
   //  NSLog(@"calculando a velocidade da  plataforma %f",platformSpeed);
}
...
- (void) getImageSize
{
 //   CCSprite *getFileSize = [CCSprite spriteWithFile:middleImageName];
    CCSprite *getFileSize = [CCSprite spriteWithSpriteFrameName:@"platform.png"];
	platformWidth = getFileSize.textureRect.size.width-1;
    platformHeight = getFileSize.textureRect.size.height-1;
